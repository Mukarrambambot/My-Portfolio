    ...
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-blue-900 via-purple-900 to-red-900">
      ...
      <div className="relative container mx-auto px-6 py-24 flex flex-col items-center justify-center min-h-screen">
        <div className="animate-fadeIn">
          <div className="w-48 h-48 rounded-full border-4 border-blue-500 overflow-hidden mb-8 mx-auto shadow-xl hover:scale-105 transition-transform duration-300">
            <img
          ...
          <p className="text-xl text-blue-200 mb-8 text-center animate-slideUp animation-delay-200">
          ...
          <div className="flex gap-6 justify-center mb-12 animate-slideUp animation-delay-400">
            ...
            <a href="#gaming" className="text-white hover:text-blue-400 transition-colors">
              <GamepadIcon size={24} />
            </a>
          </div>
